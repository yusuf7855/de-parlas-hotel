...
function ContactUs() {
    ...
    const handleEmailClick = () => {
        window.open("mailto:deperlasturizm@gmail.com", "_self");
    };
                ...
                title={
                    <Box sx={{display: "flex", alignItems: "center", gap: 1.5}}>
                        <Box sx={{
                            ...
                            <Phone sx={{fontSize: "18px", color: "#C77A63"}}/>
                        </Box>
                        <Box>
                ...
                title={
                    <Box sx={{display: "flex", alignItems: "center", gap: 1.5}}>
                        <Box sx={{
                            ...
                            <Mail sx={{fontSize: "18px", color: "#C77A63"}}/>
                        </Box>
                        <Box>
                            <Box sx={{fontSize: "14px", fontWeight: 600}}>
                                deperlasturizm@gmail.com
                            </Box>
                            <Box sx={{fontSize: "12px", opacity: 0.7, mt: 0.2}}>
                ...
                title={
                    <Box sx={{display: "flex", alignItems: "center", gap: 1.5}}>
                        <Box sx={{
                            ...
                            <Map sx={{fontSize: "18px", color: "#C77A63"}}/>
                        </Box>
                        <Box>
                            <Box sx={{fontSize: "14px", fontWeight: 600}}>
