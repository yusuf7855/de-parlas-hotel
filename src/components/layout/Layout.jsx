...
import {Apartment, Engineering, Home, Phone} from "@mui/icons-material";
import logoLight from "../../assets/images/logo_white1.png"
import logoDark from "../../assets/images/logo_white1.png"
                ...
                freeLayout !== true ?
                    <Box className={"content-wrapper"} sx={{
                        ...
                        <Toolbar sx={{
                            ...
                            display: isTransparent ? "none" : {mlg: "none"}
                        }}/>
                        <Sidebar
                            isLowerThanMd={isLowerThanMd}
