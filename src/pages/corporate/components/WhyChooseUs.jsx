...
function WhyChooseUs() {
    const data = [
        {
            icon: <Hotel sx={{ fontSize: "48px", color: "#C77A63" }} />,
        ...
        {
            icon: <RoomService sx={{ fontSize: "48px", color: "#C77A63" }} />,
        ...
        {
            icon: <Wifi sx={{ fontSize: "48px", color: "#C77A63" }} />,
        ...
        {
            icon: <LocalParking sx={{ fontSize: "48px", color: "#C77A63" }} />,
                            ...
                            >
                                <Box sx={{
                                    ...
                                    "::before": {
                                        ...
                                        right: 0,
                                        height: "4px",
                                        background: "linear-gradient(90deg, #C77A63 0%, #D4967D 100%)",
