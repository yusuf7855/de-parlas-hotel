        ...
        >
            ...
            <Box
                sx={{
                    ...
                    borderRadius: '50%',
                    background: 'linear-gradient(135deg, #C77A63 0%, #D4967D 100%)',
                    opacity: 0.15,
                    filter: 'blur(120px)',
                    zIndex: 0,
                }}
            ...
            <Box
                sx={{
                    ...
                    width: '150px',
                    borderRadius: '50%',
                    background: 'linear-gradient(135deg, #F5E6E0 0%, #C77A63 100%)',
                    opacity: 0.1,
                    filter: 'blur(60px)',
                    zIndex: 0,
                }}
                ...
                <StyledContainer>
                    <RevealInViewAnimation blur={true} size={20} style={{display: "flex", justifyContent: "center"}}
                        ...
                        <Typography sx={{
                            ...
                            lineHeight: 1.2,
                            background: "linear-gradient(135deg, #C77A63 0%, #B86A52 50%, #333 100%)",
